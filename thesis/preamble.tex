...
\numberwithin{equation}{chapter}    % Формула вида секция.номер
...
\hypersetup{
    ...
    pdfauthor={Владислав Прекель},
    pdftitle={Система физического моделирования на основе априорного подхода обнаружения столкновений}
}
