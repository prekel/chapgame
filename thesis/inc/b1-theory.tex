...
\begin{equation}\label{bodybodycollision}
  \left|\vec{r_1} - \vec{r_2}\right| = r_1 + r_2
\end{equation}
...
\begin{Underequation}
  \(x_1\)~-- координата положения первого тела по оси \(X\);
  
  \(y_1\)~-- координата положения первого тела по оси \(Y\);

  \(x_2\)~-- координата положения второго тела по оси \(X\);
  
  \(y_2\)~-- координата положения второго тела по оси \(Y\).
\end{Underequation}
