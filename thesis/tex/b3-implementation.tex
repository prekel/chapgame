...
результатом вычисления которых являются скалярные или векторные величины. При этом, для построения выражений, скалярные выражения
...
\textbf{Выражение-многочлен}.\TODO
