...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm,trim={1cm 7cm 1cm 5cm},clip]{libsdiagram}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm,trim={0cm 26cm 7cm 0cm},clip]{derivative}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm,trim={0cm 23.5cm 6cm 0cm},clip]{roots}
...
Для этого выражание представлено \TODO
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm,trim={1cm 9cm 6cm 1cm},clip]{exprdiagram}
...
\begin{centering}
    \begin{longtable}{|l|l|l|}
        ...
        \multirow{2}{*}{Coeff}                                & \href{https://github.com/prekel/chapgame/blob/master/lib/expr/coeff.ml}{lib/expr/coeff.ml}                       & \multirow{2}{*}{Коэффициент}              \\*
                                                              & \href{https://github.com/prekel/chapgame/blob/master/lib/expr/coeff\_intf.ml}{lib/expr/coeff\_intf.ml}           &                                           \\ \hline
        \multirow{2}{*}{Polynomial}                           & \href{https://github.com/prekel/chapgame/blob/master/lib/expr/polynomial.ml}{lib/expr/polynomial.ml}             & \multirow{2}{*}{Многочлен}                \\*
