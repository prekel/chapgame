...
тот, который отражает формулы~(\ref{v_x_1}),~(\ref{v_y_1}),~(\ref{r_x_1})~(\ref{r_y_1});
...
\textbf{Сцена} и \textbf{сцены}. \TODO\label{scenedescr}

\textbf{Действие}. \TODO\label{actiondescr}
