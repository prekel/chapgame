...
\newcommand\Tasks{\begin{itemize}
        \item определить модель и систематизировать математическую базу, требующуюся для реализации;
        ...
        \item продемонстрировать работу движка и рассказать о возможном развитии.
    \end{itemize}}
