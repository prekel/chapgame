...
\usepackage{graphicx,xcolor} % Вставка картинок и дополнений
\usepackage{svg}
...
\newcommand\Tasks{\begin{itemize}
        \item определить модель и теоретизировать математическую базу, требующуюся для \TODO; %решения моделирования;
